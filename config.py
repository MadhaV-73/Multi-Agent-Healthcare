...
# Standard OTC dosages (simplified reference) - Respiratory/Chest conditions only
DOSAGE_DATABASE = {
    "Paracetamol": {
    ...
    "Cetirizine": {
        ...
        "max_daily": "10 mg",
        "warnings": ["May cause drowsiness", "For respiratory allergies"]
    },
    "Cough Syrup": {
        "adult_dose": "10 ml",
    ...
    "Guaifenesin": {
        ...
        "max_daily": "2400 mg",
        "warnings": ["Take with plenty of water", "For chest congestion"]
    },
    "Salbutamol Inhaler": {
        "adult_dose": "1-2 puffs",
